...
wget -qL https://github.com/andryx86/proxmox_multi_lxc/raw/master/honeygain/setup.sh
...
pct set $CTID -description "Access honeygain interface using the following URL.
...
info "Successfully created honeygain LXC to $CTID."
